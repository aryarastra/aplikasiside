...
public class DatabaseConfiguration {
    ...
    public boolean isMigrationRequired(int fromVersion, int toVersion) {
        ...
        return !(isDowngrade && this.allowDestructiveMigrationOnDowngrade) && this.requireMigration && ((set = this.mMigrationNotRequiredFrom) == null || !set.contains(Integer.valueOf(fromVersion)));
    }
}
