...
public class TypefaceCompatApi29Impl extends TypefaceCompatBaseImpl {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:158:0x0070, code lost:
        r5 = androidx.constraintlayout.core.motion.utils.TypedValues.Transition.TYPE_DURATION;
     */
    ...
    */
    ...
    public Typeface createFromFontFamilyFilesResourceEntry(Context context, FontResourcesParserCompat.FontFamilyFilesResourceEntry familyEntry, Resources resources, int style) {
        ...
        try {
            ...
            FontStyle defaultStyle = new FontStyle((style & 1) != 0 ? TypedValues.Transition.TYPE_DURATION : 400, (style & 2) != 0 ? 1 : 0);
