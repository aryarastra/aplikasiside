...
public class MotionKeyCycle extends MotionKey {
    ...
    public float getValue(String key) {
        ...
        switch (key.hashCode()) {
            ...
            case -1225497655:
                ...
                break;
            case -1019779949:
                if (key.equals(TypedValues.Cycle.S_WAVE_OFFSET)) {
                    c = 11;
                    break;
                }
                c = 65535;
            ...
            case 92909918:
                ...
                break;
            case 106629499:
                if (key.equals(TypedValues.Cycle.S_WAVE_PHASE)) {
                    c = '\f';
                    break;
                }
                c = 65535;
    ...
    public int getId(String name) {
        ...
        switch (name.hashCode()) {
            case -1581616630:
                if (name.equals(TypedValues.Cycle.S_CUSTOM_WAVE_SHAPE)) {
                    c = 20;
                    break;
                }
                c = 65535;
            ...
            case -1225497655:
                ...
                break;
            case -1019779949:
                if (name.equals(TypedValues.Cycle.S_WAVE_OFFSET)) {
                    c = 19;
                    break;
                }
                c = 65535;
            ...
            case -1001078227:
                ...
                break;
            case -991726143:
                if (name.equals(TypedValues.Cycle.S_WAVE_PERIOD)) {
                    c = 16;
                    break;
                }
                c = 65535;
            ...
            case 92909918:
                ...
                break;
            case 106629499:
                if (name.equals(TypedValues.Cycle.S_WAVE_PHASE)) {
                    c = 18;
                    break;
                }
                c = 65535;
