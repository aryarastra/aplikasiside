...
public class Flow extends VirtualLayout {
    ...
    /* JADX WARN: Incorrect condition in loop: B:102:0x0068 */
    ...
    */
    ...
    public class WidgetsList {
        ...
        public WidgetsList(int orientation, ConstraintAnchor left, ConstraintAnchor top, ConstraintAnchor right, ConstraintAnchor bottom, int max) {
            ...
            this.mRight = right;
            this.mBottom = bottom;
            this.mPaddingLeft = r3.getPaddingLeft();
            this.mPaddingTop = r3.getPaddingTop();
            this.mPaddingRight = r3.getPaddingRight();
            this.mPaddingBottom = r3.getPaddingBottom();
            this.mMax = max;
        }
