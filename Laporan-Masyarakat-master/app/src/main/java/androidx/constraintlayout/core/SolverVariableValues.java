    ...
    public String toString() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (v != null) {
                ...
                String str3 = (this.previous[index] != -1 ? str2 + this.mCache.mIndexedVariables[this.variables[this.previous[index]]] : str2 + SchedulerSupport.NONE) + ", n: ";
                str = (this.next[index] != -1 ? str3 + this.mCache.mIndexedVariables[this.variables[this.next[index]]] : str3 + SchedulerSupport.NONE) + "]";
            }
        }
        return str + " }";
    }
