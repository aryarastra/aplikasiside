...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    /* JADX WARN: Removed duplicated region for block: B:209:0x002e A[RETURN] */
    /* JADX WARN: Removed duplicated region for block: B:210:0x002f  */
    /*
    ...
    */
    ...
    public class Model {
        ...
        private void debugLayoutParam(String str, ConstraintLayout.LayoutParams params) {
            ...
            Log.v(MotionLayout.TAG, valueOf26.length() != 0 ? valueOf25.concat(valueOf26) : new String(valueOf25));
        }
        ...
        private void debugWidget(String str, ConstraintWidget child) {
            ...
            if (constraintAnchor != null) {
                String valueOf2 = String.valueOf(child.mTop.mTarget.mType == ConstraintAnchor.Type.TOP ? ExifInterface.GPS_DIRECTION_TRUE : "B");
                str2 = valueOf2.length() != 0 ? ExifInterface.GPS_DIRECTION_TRUE.concat(valueOf2) : new String(ExifInterface.GPS_DIRECTION_TRUE);
            } else {
                str2 = "__";
            }
            ...
            if (child.mRight.mTarget != null) {
                ...
                str6 = valueOf11.length() != 0 ? "R".concat(valueOf11) : new String("R");
            }
        ...
        private void debugLayout(String title, ConstraintWidgetContainer c) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                String valueOf3 = String.valueOf(child.mTop.mTarget != null ? ExifInterface.GPS_DIRECTION_TRUE : "_");
                ...
                if (v instanceof TextView) {
                    ...
                    String valueOf11 = String.valueOf(((TextView) v).getText());
    ...
    private class DevModeDraw {
        ...
        private void drawPathCartesianTicks(Canvas canvas, float x, float y) {
            ...
            StringBuilder sb = new StringBuilder(15);
            sb.append(((int) (((xgap * 100.0f) / Math.abs(x2 - x1)) + 0.5d)) / 100.0f);
            String text = sb.toString();
            getTextBounds(text, this.mTextPaint);
            ...
            sb2.append(((int) (((ygap * 100.0f) / Math.abs(y2 - y1)) + 0.5d)) / 100.0f);
        ...
        private void drawPathScreenTicks(Canvas canvas, float x, float y, int viewWidth, int viewHeight) {
            ...
            StringBuilder sb2 = new StringBuilder(15);
            sb2.append(((int) ((((y - (viewHeight / 2)) * 100.0f) / (MotionLayout.this.getHeight() - viewHeight)) + 0.5d)) / 100.0f);
            String text2 = sb2.toString();
            getTextBounds(text2, this.mTextPaint);
