...
public abstract class Single<T> implements SingleSource<T> {
    ...
    public final void subscribe(SingleObserver<? super T> observer) {
        ...
        Objects.requireNonNull(observer2, "The RxJavaPlugins.onSubscribe hook returned a null SingleObserver. Please check the handler provided to RxJavaPlugins.setOnSingleSubscribe for invalid null returns. Further reading: https://github.com/ReactiveX/RxJava/wiki/Plugins");
        try {
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <R> R to(SingleConverter<T, ? extends R> converter) {
