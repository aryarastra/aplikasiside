...
public abstract class Completable implements CompletableSource {
    ...
    public final void subscribe(CompletableObserver observer) {
        ...
        try {
            ...
            Objects.requireNonNull(observer2, "The RxJavaPlugins.onSubscribe hook returned a null CompletableObserver. Please check the handler provided to RxJavaPlugins.setOnCompletableSubscribe for invalid null returns. Further reading: https://github.com/ReactiveX/RxJava/wiki/Plugins");
