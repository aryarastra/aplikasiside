...
public final class FutureSubscriber<T> extends CountDownLatch implements FlowableSubscriber<T>, Future<T>, Subscription {
    ...
    public void onError(Throwable t) {
        Subscription a;
        if (this.error == null && (a = this.upstream.get()) != this && a != SubscriptionHelper.CANCELLED && this.upstream.compareAndSet(a, this)) {
            this.error = t;
            countDown();
            return;
        }
    ...
    public void onComplete() {
        ...
        if (a != this && a != SubscriptionHelper.CANCELLED && this.upstream.compareAndSet(a, this)) {
            countDown();
        }
    }
