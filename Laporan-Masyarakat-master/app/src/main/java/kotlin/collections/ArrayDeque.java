...
public final class ArrayDeque<E> extends AbstractMutableList<E> {
    ...
    /* JADX WARN: Removed duplicated region for block: B:56:0x0050 A[LOOP:2: B:56:0x0050->B:60:0x0061, LOOP_START, PHI: r1 
      PHI: (r1v6 int) = (r1v5 int), (r1v7 int) binds: [B:55:0x004e, B:60:0x0061] A[DONT_GENERATE, DONT_INLINE]] */
    @Override // java.util.AbstractList, java.util.List
    /*
