...
public class UIntProgression implements Iterable<UInt>, KMappedMarker {
    ...
    private UIntProgression(int start, int endInclusive, int step) {
        ...
        this.first = start;
        this.last = UProgressionUtilKt.m1243getProgressionLastElementNkh28Cs(start, endInclusive, step);
        this.step = step;
    }
    ...
    public final Iterator<UInt> iterator() {
        return new UIntProgressionIterator(m1257getFirstpVg5ArA(), m1258getLastpVg5ArA(), this.step, null);
    }

    public boolean isEmpty() {
        if (this.step > 0) {
            if (UnsignedKt.uintCompare(m1257getFirstpVg5ArA(), m1258getLastpVg5ArA()) > 0) {
                return true;
            }
        } else if (UnsignedKt.uintCompare(m1257getFirstpVg5ArA(), m1258getLastpVg5ArA()) < 0) {
            return true;
        }
        return false;
    }
    ...
    public boolean equals(Object other) {
        return (other instanceof UIntProgression) && ((isEmpty() && ((UIntProgression) other).isEmpty()) || (m1257getFirstpVg5ArA() == ((UIntProgression) other).m1257getFirstpVg5ArA() && m1258getLastpVg5ArA() == ((UIntProgression) other).m1258getLastpVg5ArA() && this.step == ((UIntProgression) other).step));
    }
    ...
    public int hashCode() {
        ...
        return (((m1257getFirstpVg5ArA() * 31) + m1258getLastpVg5ArA()) * 31) + this.step;
    }
    ...
    public String toString() {
        ...
        if (this.step > 0) {
            ...
            sb.append((Object) UInt.m191toStringimpl(m1257getFirstpVg5ArA()));
            sb.append("..");
            sb.append((Object) UInt.m191toStringimpl(m1258getLastpVg5ArA()));
            sb.append(" step ");
            i = this.step;
        } else {
            sb = new StringBuilder();
