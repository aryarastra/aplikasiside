        ...
        while (i < length) {
            ...
            if (t != t2) {
                ...
                if ((t instanceof Object[]) && (t2 instanceof Object[])) {
                    ...
                    if (!UArraysKt.m594contentEqualskV0jMPg(((UByteArray) t).m136unboximpl(), ((UByteArray) t2).m136unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UShortArray) && (t2 instanceof UShortArray)) {
                    if (!UArraysKt.m591contentEqualsFGO6Aew(((UShortArray) t).m396unboximpl(), ((UShortArray) t2).m396unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof UIntArray) && (t2 instanceof UIntArray)) {
                    if (!UArraysKt.m592contentEqualsKJPZfPQ(((UIntArray) t).m214unboximpl(), ((UIntArray) t2).m214unboximpl())) {
                        return false;
                    }
                } else if ((t instanceof ULongArray) && (t2 instanceof ULongArray)) {
                    if (!UArraysKt.m596contentEqualslec5QzE(((ULongArray) t).m292unboximpl(), ((ULongArray) t2).m292unboximpl())) {
                        return false;
                    }
        ...
        while (i < length) {
            ...
            if (t == null) {
                ...
                if (t instanceof UByteArray) {
                    ...
                    result.append(UArraysKt.m608contentToString2csIQuQ(uByteArray != null ? uByteArray.m136unboximpl() : null));
                } else if (t instanceof UShortArray) {
                    UShortArray uShortArray = (UShortArray) t;
                    result.append(UArraysKt.m612contentToStringd6D3K8(uShortArray != null ? uShortArray.m396unboximpl() : null));
                } else if (t instanceof UIntArray) {
                    UIntArray uIntArray = (UIntArray) t;
                    result.append(UArraysKt.m611contentToStringXUkPCBk(uIntArray != null ? uIntArray.m214unboximpl() : null));
                } else if (t instanceof ULongArray) {
                    ULongArray uLongArray = (ULongArray) t;
                    result.append(UArraysKt.m614contentToStringuLth9ew(uLongArray != null ? uLongArray.m292unboximpl() : null));
                } else {
