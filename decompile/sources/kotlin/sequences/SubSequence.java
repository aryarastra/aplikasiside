...
public final class SubSequence<T> implements Sequence<T>, DropTakeSequence<T> {
    ...
    public SubSequence(Sequence<? extends T> sequence, int startIndex, int endIndex) {
        ...
        if (!(startIndex >= 0)) {
            throw new IllegalArgumentException(Intrinsics.stringPlus("startIndex should be non-negative, but is ", Integer.valueOf(startIndex)).toString());
        }
        if (!(endIndex >= 0)) {
            throw new IllegalArgumentException(Intrinsics.stringPlus("endIndex should be non-negative, but is ", Integer.valueOf(endIndex)).toString());
        }
