...
public final class zzc {
    ...
    private static zzs zzb(final String str, final zzd zzdVar, final boolean z, boolean z2) {
        try {
            zzb();
            Preconditions.checkNotNull(zzc);
            try {
    ...
    public static final /* synthetic */ String zza(boolean z, String str, zzd zzdVar) throws Exception {
        boolean z2 = true;
        return zzs.zza(str, zzdVar, z, (z || !zzb(str, zzdVar, true, false).zza) ? false : false);
    }
}
