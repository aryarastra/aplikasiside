...
public abstract class Maybe<T> implements MaybeSource<T> {
    ...
    @CheckReturnValue
    @SchedulerSupport(SchedulerSupport.NONE)
    public final <R> R to(MaybeConverter<T, ? extends R> converter) {
    ...
    public final void subscribe(MaybeObserver<? super T> observer) {
        ...
        Objects.requireNonNull(observer2, "The RxJavaPlugins.onSubscribe hook returned a null MaybeObserver. Please check the handler provided to RxJavaPlugins.setOnMaybeSubscribe for invalid null returns. Further reading: https://github.com/ReactiveX/RxJava/wiki/Plugins");
        try {
